...
func (p *Probe) Init(client *statsd.Client) error {
	...
	var err error
	p.ddmon, err = NewDdmon(p.handleEvent)
...
// handleEvent shares the same name of the Linux implementation, but with different signature.
// This function is called with native Go data types when I/O activities are available.
func (p *Probe) handleEvent(records []DdmonFileActivityRecord) int32 {
	if records != nil {
		for _, e := range records {
			event := p.translateEvent(&e)
			p.DispatchEvent(&event, 0, 0, nil)
		}
	}
	return 0
}

func (p *Probe) translateEvent(r *DdmonFileActivityRecord) Event {
	var e Event
	//e.MarshalJSON()
	// TODO: mikezhu Revisit those fields.
	e.ID = "test"
	e.Timestamp = time.Now()
	e.TimestampRaw = 0
	e.Type =0

	e.WinIo.OriginatingTime = r.CoreRecordInfo.OriginatingTime
	e.WinIo.CompletionTime = r.CoreRecordInfo.CompletionTime
	e.WinIo.DeviceObject  = r.CoreRecordInfo.DeviceObject
	e.WinIo.FileObject    = r.CoreRecordInfo.FileObject
	e.WinIo.Transaction   = r.CoreRecordInfo.Transaction
	e.WinIo.ProcessId = r.CoreRecordInfo.ProcessId
	e.WinIo.ThreadId   = r.CoreRecordInfo.ThreadId
	e.WinIo.IrpFlags  = r.CoreRecordInfo.IrpFlags
	e.WinIo.Flags     = r.CoreRecordInfo.Flags
	e.WinIo.CallbackMajorId = r.CoreRecordInfo.CallbackMajorId
	e.WinIo.CallbackMinorId  = r.CoreRecordInfo.CallbackMinorId
	e.WinIo.EcpCount      = r.CoreRecordInfo.EcpCount
	e.WinIo.KnownEcpMask  = r.CoreRecordInfo.KnownEcpMask
	e.WinIo.Status  = r.CoreRecordInfo.Status
	e.WinIo.Information  = r.CoreRecordInfo.Information
	e.WinIo.Arg1  = r.CoreRecordInfo.Arg1
	e.WinIo.Arg2  = r.CoreRecordInfo.Arg2
	e.WinIo.Arg3  = r.CoreRecordInfo.Arg3
	e.WinIo.Arg4  = r.CoreRecordInfo.Arg4
	e.WinIo.Arg5  = r.CoreRecordInfo.Arg5
	e.WinIo.Arg6  = r.CoreRecordInfo.Arg6
	e.WinIo.UserName = r.UserName
	e.WinIo.ProcessName = r.ProcessName
	e.WinIo.FileName = r.FileName
...
// SetEventHandler set a module as the probe event handler
...
func (p *Probe) DispatchEvent(event *Event, size uint64, CPU int, perfMap *manager.PerfMap) {
	...
	// TODO: mikezhu Should use the code below?
...
var eventZero Event
// TODO: mikezhu How is this function used?
