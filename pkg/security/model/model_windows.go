...
type Event struct {
	...
	WinIo        WinIoEvent   `field:"winio" event:"winio"`
}

type WinIoEvent struct {
	OriginatingTime uint64 `field:"originatingtime"`
	CompletionTime  uint64 `field:"completiontime"`

	DeviceObject uint64 `field:"deviceobject"`
	FileObject   uint64 `field:"fileobject"`
	Transaction  uint64 `field:"transaction"`

	ProcessId uint64 `field:"processid"`
	ThreadId  uint64 `field:"threadid"`

	IrpFlags uint32 `field:"irpflags"`
	Flags    uint32 `field:"flags"`

	CallbackMajorId uint8 `field:"callbackmajorid"`
	CallbackMinorId uint8 `field:"callbackminorid"`

	EcpCount     uint32 `field:"ecpcount"`
	KnownEcpMask uint32 `field:"knownecpmask"`

	Status int32 `field:"status"`

	Information uint64 `field:"information"`

	Arg1 uint64 `field:"arg1"`
	Arg2 uint64 `field:"arg2"`
	Arg3 uint64 `field:"arg3"`
	Arg4 uint64 `field:"arg4"`
	Arg5 uint64 `field:"arg5"`
	Arg6 uint64 `field:"arg6"`

	UserName       string `field:"username"`
	ProcessName    string `field:"processname"`
