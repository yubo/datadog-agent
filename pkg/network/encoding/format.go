...
func formatDNSStatsByDomainByQueryType(stats map[*stringintern.Value]map[dns.QueryType]dns.Stats, domainSet map[string]int) map[int32]*model.DNSStatsByQueryType {
...
func formatDNSStatsByDomain(stats map[*stringintern.Value]map[dns.QueryType]dns.Stats, domainSet map[string]int) map[int32]*model.DNSStats {
