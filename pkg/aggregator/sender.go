...
func (s *checkSender) Gauge(metric string, value float64, hostname string, tags []string) {
	log.Infof("CheckSender Gauge: name: %v, value: %v, type: %v, typestring: %v", metric, value, metrics.GaugeType, metrics.GaugeType.String())
...
func (s *checkSender) Rate(metric string, value float64, hostname string, tags []string) {
	log.Infof("CheckSender Rate: name: %v, value: %v, type: %v, typestring: %v", metric, value, metrics.RateType, metrics.RateType.String())
