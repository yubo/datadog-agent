...
func NewProvider(numberOfPipelines int, auditor auditor.Auditor, diagnosticMessageReceiver diagnostic.MessageReceiver, processingRules []*ProcessingRule, endpoints *Endpoints, destinationsContext *client.DestinationsContext) Provider {
...
func NewServerlessProvider(numberOfPipelines int, auditor auditor.Auditor, processingRules []*ProcessingRule, endpoints *Endpoints, destinationsContext *client.DestinationsContext) Provider {
...
func newProvider(numberOfPipelines int, auditor auditor.Auditor, diagnosticMessageReceiver diagnostic.MessageReceiver, processingRules []*ProcessingRule, endpoints *Endpoints, destinationsContext *client.DestinationsContext, serverless bool) Provider {
	return &provider{
