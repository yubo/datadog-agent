...
func (c *DCAClient) PostClusterCheckStatus(identifier string, status types.RunnerStatus) (types.StatusResponse, error) {
...
func (c *DCAClient) doPostClusterCheckStatus(identifier string, status types.RunnerStatus) (types.StatusResponse, error) {
